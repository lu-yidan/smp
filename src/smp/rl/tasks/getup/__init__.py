...
from smp.rl.tasks.getup.escape_v33_deploy_env_cfg import (
  g1_getup_escape_plate_v33_deploy_smp_env_cfg,
)
...
_escape_plate_v33_deploy_getup_rl = unitree_g1_smp_ppo_runner_cfg()
_escape_plate_v33_deploy_getup_rl.experiment_name = (
  "smp_getup_escape_plate_v33_deploy_g1"
)
_escape_plate_v33_deploy_getup_rl.run_name = "smp_getup_escape_plate_v33_deploy_g1"
_escape_plate_v33_deploy_getup_rl.save_interval = 250
_escape_plate_v33_deploy_getup_rl.actor.distribution_cfg["init_std"] = 0.15

register_mjlab_task(
  task_id="Smp-Getup-Escape-Plate-V33-Deploy-G1",
  env_cfg=g1_getup_escape_plate_v33_deploy_smp_env_cfg(play=False),
  play_env_cfg=g1_getup_escape_plate_v33_deploy_smp_env_cfg(play=True),
  rl_cfg=_escape_plate_v33_deploy_getup_rl,
)
