...
register_mjlab_task(
  task_id="Smp-Getup-Scratch-A8-F2S2-Balanced-Bridge-G1",
  env_cfg=g1_scratch_a8_f2s2_balanced_bridge_env_cfg(play=False),
  play_env_cfg=g1_scratch_a8_f2s2_balanced_bridge_env_cfg(play=True),
  rl_cfg=_scratch_causal_runner("smp_scratch_a8_f2s2_balanced_bridge_g1"),
)

register_mjlab_task(
  task_id="Smp-Getup-Scratch-A9-F2S2-Objective-Aligned-G1",
...
register_mjlab_task(
  task_id="Smp-Getup-Scratch-A11-F2S2-Grounded-Safety-G1",
  env_cfg=g1_scratch_a11_f2s2_grounded_safety_env_cfg(play=False),
  play_env_cfg=g1_scratch_a11_f2s2_grounded_safety_env_cfg(play=True),
  rl_cfg=_scratch_causal_runner("smp_scratch_a11_f2s2_grounded_safety_g1"),
  runner_cls=SmpCurriculumWarmStartRunner,
)

register_mjlab_task(
  task_id="Smp-Getup-Scratch-A12-F2S2-Prone-Coverage-G1",
  env_cfg=g1_scratch_a12_f2s2_prone_coverage_env_cfg(play=False),
  play_env_cfg=g1_scratch_a12_f2s2_prone_coverage_env_cfg(play=True),
  rl_cfg=_scratch_causal_runner("smp_scratch_a12_f2s2_prone_coverage_g1"),
  runner_cls=SmpCurriculumWarmStartRunner,
)

register_mjlab_task(
  task_id="Smp-Getup-Scratch-A13-F2S2-Continuous-Reset-G1",
...
def _register_v38_93d_route_task(task_suffix, experiment_suffix, builder):
  rl_cfg = unitree_g1_smp_ppo_runner_cfg()
  rl_cfg.experiment_name = f"smp_getup_v38_93d_{experiment_suffix}_g1"
  rl_cfg.run_name = f"smp_getup_v38_93d_{experiment_suffix}_g1"
  rl_cfg.save_interval = 500
  register_mjlab_task(
    task_id=f"Smp-Getup-V38-93D-{task_suffix}-G1",
    env_cfg=builder(play=False),
    play_env_cfg=builder(play=True),
    rl_cfg=rl_cfg,
    runner_cls=SmpCurriculumWarmStartRunner,
...
_register_v38_93d_route_task(
  "Control", "control", g1_getup_v38_93d_control_env_cfg
)
_register_v38_93d_route_task(
